...
describe("test Input component", () => {
  it("should render the correct default Input", () => {
    ...
    expect(testNode).toHaveClass("flame-input-inner");
  ...
  it("should render different input sizes on size property", () => {
    ...
    const testContainer = view.container.querySelector(".flame-input-wrapper");
  ...
  it("should render prepand and append element on prepand/append property", () => {
    ...
    // eslint-disable-next-line
    const testContainer = container.querySelector(".flame-input-wrapper");
